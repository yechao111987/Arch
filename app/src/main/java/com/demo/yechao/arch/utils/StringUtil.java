...
public class StringUtil {
    ...
    /*  1. null                                                                     */
    /*  2. empty - ""                                                               */
    /*  3. blank - "全部是空�? - 空白由Character.isWhitespace�?��义�?              */
    /* ============================================================================ */

    /**
     * �?��字符串是否为<code>null</code>或空字符�?code>""</code>�?
     * <pre>
    ...
    /**
     * 如果字符串是<code>null</code>或空字符�?code>""</code>，则返回空字符串<code>""</code>，否则返回字符串本身�?
     * 
     * <p>
    ...
    /**
     * 如果字符串是空白�?code>null</code>、空字符�?code>""</code>或只有空白字符，则返回空字符�?code>""</code>，否则返回字符串本身�?
     * <pre>
     ...
     * @param str 要处理的字符�?
     *
     * @return 除去空白的字符串，如果原字串�?code>null</code>或结果字符串�?code>""</code>，则返回<code>null</code>
     */
     ...
     * @param str2 要比较的字符�?
     *
     * @return 如果两个字符串相同，或�?都是<code>null</code>，则返回<code>true</code>
     */
     ...
     * 
     * <p>
     * <code>null</code>将返�?code>false</code>，空字符�?code>""</code>将返�?code>true</code>�?
     * </p>
     * <pre>
     ...
     * @param str 要检查的字符�?
     *
     * @return 如果字符串非<code>null</code>并且全由unicode字母数字和空格组成，则返�?code>true</code>
     */
        ...
        public String parse(String str) {
            ...
            for (int index = 0; index < length; index++) {
                ...
                if (Character.isUpperCase(ch)) {
                    ...
                    // 2. wordIndex == index，说明index处为�?��titleCaseWord�?
     ...
     * 
     * <p>
     * 分隔符不会出现在目标数组中，连续的分隔符就被看作。如果字符串code>null</code>，则返回<code>null</code>�?
     * <pre>
     * StringUtil.split(null, *)         = null
     * StringUtil.split("", *)           = []
     ...
     * @param str 要分割的字符�?
     * @param separatorChars 分隔�?
     * @param max 返回的数组的�?��个数，如果小于等�?，则表示无限�?
     *
     * @return 分割后的字符串数组，如果原字符串�?code>null</code>，则返回<code>null</code>
     */
    ...
    /**
     * 在字符串中查找指定字符，并返回第�?��匹配的索引�?。如果字符串�?code>null</code>或未找到，则返回<code>-1</code>�?
     * <pre>
    ...
    /**
     * 在字符串中查找指定字符集合中的字符，并返回第�?��匹配的起始索引�? 如果字符串为<code>null</code>，则返回<code>-1</code>�?
    ...
    /**
     * 在字符串中查找指定字符串集合中的字符串，并返回第�?��匹配的起始索引�? 如果字符串为<code>null</code>，则返回<code>-1</code>�?
     * 如果字符串集合为<code>null</code>或空，也返回<code>-1</code>�?
     * 如果字符串集合包�?code>""</code>，并且字符串不为<code>null</code>，则返回<code>str.length()</code>
     * <pre>
     * StringUtil.indexOfAny(null, *)                     = -1
     * StringUtil.indexOfAny(*, null)                     = -1
     * StringUtil.indexOfAny(*, [])                       = -1
    ...
    /**
     * 在字符串中查找不在指定字符集合中的字符，并返回第�?��匹配的起始索引�? 如果字符串为<code>null</code>，则返回<code>-1</code>�?
     * 如果字符集合�?code>null</code>或空，也返回<code>-1</code>�?
     * <pre>
    ...
    /**
     * 从字符串尾部�?��查找指定字符，并返回第一个匹配的索引值�?如果字符串为<code>null</code>或未找到，则返回<code>-1</code>�?
     * <pre>
    ...
    /**
     * 从字符串尾部�?��查找指定字符串，并返回第�?��匹配的索引�?。如果字符串�?code>null</code>或未找到，则返回<code>-1</code>�?
     * <pre>
     * StringUtil.lastIndexOf(null, *)         = -1
     * StringUtil.lastIndexOf("", *)           = -1
     * StringUtil.lastIndexOf("aabaabaa", 'a') = 7
    ...
    /**
     * 从字符串尾部�?��查找指定字符串集合中的字符串，并返回第一个匹配的起始索引�?如果字符串为<code>null</code>，则返回<code>-1</code>�?
     * 如果字符串集合为<code>null</code>或空，也返回<code>-1</code>�?
     * 如果字符串集合包�?code>""</code>，并且字符串不为<code>null</code>，则返回<code>str.length()</code>
     * <pre>
    ...
    /**
     * �?��字符串中是否包含指定的字符�?如果字符串为<code>null</code>，将返回<code>false</code>�?
     * <pre>
    ...
    /**
     * �?��字符串中是否包含指定的字符串。如果字符串�?code>null</code>，将返回<code>false</code>�?
     * <pre>
     * StringUtil.contains(null, *)     = false
     * StringUtil.contains(*, null)     = false
     ...
     * 如果字符集合�?code>null</code>则返�?code>false</code>�?但是空字符串永远返回<code>true</code>.
     * </p>
     * <pre>
     ...
     * 
     * <p>
     * 如果字符串为<code>null</code>，则返回<code>false</code>�?如果字符集合�?code>null</code>则返�?code>true</code>�?
     ...
     * @param subStr 子字符串
     *
     * @return 子串在字符串中出现的次数，如果字符串�?code>null</code>或空，则返回<code>0</code>
     */
     ...
     * 
     * <p>
     * 如果字符串为<code>null</code>，则返回<code>null</code>�?如果分隔子串�?code>null</code>或未找到该子串，则返回原字符串�?
     * <pre>
     ...
     * 
     * <p>
     * 如果字符串为<code>null</code>，则返回<code>null</code>�?如果分隔子串�?code>null</code>，则返回<code>null</code>�?
     * <pre>
     ...
     * @param tag 要搜索的分隔子串
     *
     * @return 子串，如果原始串�?code>null</code>或未找到分隔子串，则返回<code>null</code>
     */
    ...
    /**
     * 删除�?���?code>Character.isWhitespace(char)</code>中所定义的空白�?
     * <pre>
     ...
     * @param str 要处理的字符�?
     *
     * @return 去空白后的字符串，如果原始字符串�?code>null</code>，则返回<code>null</code>
     */
     ...
     * 
     * <p>
     * 如果字符串为<code>null</code>则返�?code>null</code>，如果指定子串为<code>null</code>，则返回原字符串�?
     * <pre>
     ...
     * @param with 替换字符�?
     *
     * @return 被替换后的字符串，如果原始字符串�?code>null</code>，则返回<code>null</code>
     */
     ...
     * 
     * <p>
     * 如果字符串为<code>null</code>则返�?code>null</code>�?
     * <pre>
     ...
     * 
     * <p>
     * 如果字符串为<code>null</code>则返�?code>null</code>。如果搜索字符串�?code>null</code>或空，则返回原字符串�?
     * </p>
     * 
     * <p>
     ...
     * 
     * <p>
     * 如果字符串为<code>null</code>，则返回<code>null</code>�?负的索引值将被看�?code>0</code>，越界的索引值将被设置成字符串的长度相同的�?�?
     * <pre>
     ...
     * @param end 结束索引
     *
     * @return 被覆盖后的字符串，如果原始字符串�?code>null</code>，则返回<code>null</code>
     */
     ...
     * 
     * <p>
     * 换行符有三种情形�?quot;<code>\n</code>&quot;�?quot;<code>\r</code>&quot;�?quot;<code>\r\n</code>&quot;�?
     * <pre>
     ...
     *
     * @param str 要处理的字符�?
     * @param separator 要删除的字符�?
     *
     * @return 不以指定字符串结尾的字符串，如果原始字串�?code>null</code>，则返回<code>null</code>
     */
     ...
     * @param str 要处理的字符�?
     *
     * @return 删除�?���?��字符的字符串，如果原始字符串�?code>null</code>，则返回<code>null</code>
     */
     ...
     *
     * @param str 要重复的字符�?
     * @param repeat 重复次数，如果小�?code>0</code>，则看作<code>0</code>
     *
     ...
     * @param str 要反转的字符�?
     *
     * @return 反转后的字符串，如果原字符串�?code>null</code>，则返回<code>null</code>
     */
    ...
    /**
     * 将字符串转换成指定长度的缩略，例如： �?Now is the time for all good men"转换�?Now is the time for..."�?
     * 
     * <ul>
     * <li>
     * 如果<code>str</code>�?code>maxWidth</code>短，直接返回�?
     * </li>
     * <li>
     ...
     *
     * @param str 要检查的字符�?
     * @param maxWidth �?��长度，不小于<code>4</code>，如果小�?code>4</code>，则看作<code>4</code>
     *
     * @return 字符串缩略，如果原始字符串为<code>null</code>则返�?code>null</code>
     */
    ...
    /**
     * 将字符串转换成指定长度的缩略，例如： �?Now is the time for all good men"转换�?...is the time for..."�?
     * 
     * <p>
     * �?code>abbreviate(String, int)</code>类似，但是增加了�?��“左边界”偏移量�?
     * 注意，�?左边界�?处的字符未必出现在结果字符串的最左边，但�?��出现在结果字符串中�?
     * </p>
     * 
     * <p>
     * 返回的字符串不可能长于指定的<code>maxWidth</code>�?
     ...
     * @param str2 字符�?
     *
     * @return 第二个字符串中，和第�?��字符串不同的部分。如果两个字符串相同，则返回空字符串<code>""</code>
     */
     ...
     * @param str2 字符�?
     *
     * @return 两字符串�?��产生差异的索引�?，如果两字符串相同，则返�?code>-1</code>
     */
     ...
     * 它计算的是从字符�?转变到字符串2�?��要的删除、插入和替换的步骤数�?
     * </p>
     * <pre>
